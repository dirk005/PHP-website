...
if (isset($allEntries) === false) {
	trigger_error('admin/views/entries-html.php needs $allEntries');
}
?>
   ...
   <div class="row">
	   <?php
            ...
            //add page and id to href
             $href = "admin.php?page=editor&amp;id=$entry->Car_id";        
         ?>
                ...
                <div class=" container-fluid jumbotron ">
                    ...
                    <div class="caption" >
                        ...
                        <h3> <?php echo $entry->Title ?></h3>
                           ...
                           <h4>  Year  : <small><?php echo $entry->Transmission ?></small></h4>
                        ...
                        <p class="col-md-12">
                            <a href="<?php echo $href ?>" class="btn btn-primary">Edit</a>
                        </p>
                    </div>
                </div>
            </div>	
